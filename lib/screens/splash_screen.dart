...
class _SplashScreenState extends State<SplashScreen>
  ...
  static const Color _backgroundBase = Color(
    0xFF0D1B2A,
  ); // Derin lacivert (Parlak Koyu Tema)
  ...
  void _startAnimationSequence() async {
    ...
    const minimumSplashDuration = Duration(seconds: 5); // Minimum 5 saniye
  ...
  Widget _buildTitle(double fontSize, double screenWidth) {
    ...
    final logoSize = (screenWidth * 0.35).clamp(100.0, 180.0);

    return Column(
      children: [
        // Logo - Animasyonların tepesinde
        Container(
              width: logoSize,
              height: logoSize,
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  // Logo yüklenemezse boş container
            ...
            child:
                Text(
                      ...
                      style: GoogleFonts.bangers(
                        ...
                        color: Colors.white, // Koyu arka plan için beyaz
  ...
  /// Maskotlar - Ekrana yayılmış, yukarıdan düşen animasyon
  Widget _buildMascots(double size, double screenWidth) {
    if (!_showMascots) {
      return const SizedBox.shrink();
    }

    // Küçük ekranda daha küçük mascotlar
    final mascotSize = (size * 0.7).clamp(50.0, 100.0);

    return SizedBox(
      width: screenWidth,
      height: mascotSize * 2.5, // Yeterli yükseklik
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            top: mascotSize * 0.3,
            child: _buildFallingMascot(
              assetPath: 'assets/animation/astronot_mascot.json',
              mascotType: 'astronot',
              size: mascotSize * 0.9,
              delay: 0,
            ),
          ...
          Positioned(
            ...
            top: mascotSize * 0.8,
            child: _buildFallingMascot(
              assetPath: 'assets/animation/kaplan_mascot.json',
              mascotType: 'kaplan',
          ...
          Positioned(
            ...
            child: _buildFallingMascot(
              ...
              mascotType: 'kedi',
              size: mascotSize * 0.95,
              delay: 160,
            ),
          ),
          // Orta sağ - Köpek (merkez, biraz büyük)
          Positioned(
          ...
          Positioned(
            ...
            top: mascotSize * 0.15,
            child: _buildFallingMascot(
              assetPath: 'assets/animation/maymun_mascot.json',
              mascotType: 'maymun',
              size: mascotSize * 0.9,
              delay: 320,
            ),
  ...
  /// Yukarıdan düşen maskot animasyonu
  Widget _buildFallingMascot({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        transform: Matrix4.identity()..setEntry(1, 3, isBouncing ? -15.0 : 0.0),
        child:
            Container(
                  width: size,
                  height: size,
  ...
  Widget _buildLoadingSection(double size, double screenWidth) {
    ...
    return Column(
      children: [
        // Loading animasyonu - Basit CircularProgressIndicator
        SizedBox(
              width: size,
              height: size * 0.5,
              child: Center(
